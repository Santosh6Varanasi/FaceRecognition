...
export class FaceApiService {
  ...
  startSession(): Observable<{ session_id: string }> {
    return this.http.post<{ session_id: string }>(`${this.base}/api/stream/session/start`, {});
  }

  endSession(sessionId: string, totalFrames: number): Observable<any> {
    return this.http.post(`${this.base}/api/stream/session/end`, {
  ...
  processFrame(frameData: string, sessionId: string): Observable<FrameResult> {
    return this.http.post<FrameResult>(`${this.base}/api/stream/frame`, {
